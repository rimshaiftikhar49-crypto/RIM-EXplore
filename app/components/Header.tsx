        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex justify-between items-center text-sm">
            <div className="flex items-center space-x-6">
              <span className="text-gray-300">RIM Price: <span className="text-red-400">$4,554.69 (-1.28%)</span></span>
          ...
          <div className="flex justify-between items-center h-14">
            ...
            <Link href="/" className="flex items-center space-x-2">
              <div className="w-7 h-7 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded flex items-center justify-center shadow-sm">
                <span className="text-gray-800 font-bold text-xs">R</span>
              </div>
              <span className="text-lg font-bold text-gray-900">RIM</span>
            </Link>
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-1 w-56 bg-white border border-gray-200 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="p-2">
                    ...
                    <Link href="/aur-points" className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded">RIM Points <span className="text-xs bg-gray-200 text-gray-600 px-1 rounded">Beta</span></Link>
                ...
                <div className="absolute top-full right-0 mt-1 w-[600px] bg-white border border-gray-200 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="p-6">
                    ...
                    <div className="mb-6">
                      ...
                      <p className="text-sm text-gray-600">Discover more of RIMscan's tools and services in one place.</p>
                    </div>
