      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            The RIM <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">Blockchain</span> Explorer
          </h1>

          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Search, verify and track RIM transactions, blocks, addresses, tokens, and smart contracts on the RIM blockchain
          </p>
