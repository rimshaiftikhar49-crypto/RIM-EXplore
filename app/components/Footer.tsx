    ...
    <footer className="bg-gray-800 border-t border-gray-700 mt-16">
      <div className="container mx-auto px-4 max-w-6xl py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          {/* Powered by AUR */}
          <div>
            <h3 className="text-sm font-semibold text-gray-300 mb-3">Powered by RIM</h3>
            <ul className="space-y-2">
              <li><Link href="/" className="text-xs text-gray-400 hover:text-white transition-colors">RIM</Link></li>
        ...
        <div className="border-t border-gray-700 pt-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            <div className="flex items-center space-x-4">
              <span className="text-xs text-gray-400">RIM (RIM) Blockchain Explorer</span>
