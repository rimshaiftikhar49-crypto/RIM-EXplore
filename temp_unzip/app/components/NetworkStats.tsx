      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 card-hover">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">Staked AUR</span>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 card-hover">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-medium text-gray-900">120.3M AUR</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">Circulating</span>
              <span className="text-sm font-medium text-gray-900">118.7M AUR</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">Burned</span>
              <span className="text-sm font-medium text-red-600">4.2M AUR</span>
            </div>
          </div>
        </div>
      </div>
