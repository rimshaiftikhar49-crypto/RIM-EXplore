            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start space-x-3 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs font-medium text-gray-600 uppercase tracking-wide mb-1">AUR PRICE</div>
                  <div className="text-sm font-semibold text-gray-900 mb-1">
                    ${stats?.aurPrice?.usd?.toFixed(2) || '0.00'} @ {stats?.aurPrice?.btc?.toFixed(6) || '0.000000'} AUR
                  </div>
                ...
                {blocks.slice(0, 6).map((block, index) => (
                  <div key={block.number} className="flex items-center space-x-3 py-2 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors rounded">
                    ...
                    <div className="text-right flex-shrink-0">
                      ...
                      <div className="text-xs text-gray-500">{block.reward} AUR</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-3">
                {transactions.slice(0, 6).map((tx, index) => (
                  <div key={tx.hash} className="flex items-center space-x-3 py-2 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors rounded">
                    ...
                    <div className="text-right flex-shrink-0">
                      <div className="text-sm font-medium text-gray-900">{tx.value} AUR</div>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <div className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Powered by AUR */}
            <div>
              <h4 className="text-lg font-semibold text-yellow-400 mb-4">Powered by AUR</h4>
              <ul className="space-y-2">
                <li><Link href="/" className="text-gray-300 hover:text-yellow-400 transition-colors text-sm">AUR</Link></li>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0 md:space-x-4">
              <span className="text-gray-300 text-sm">AUR (AUR) Blockchain Explorer</span>
